...
export function buildCatalogProviders(config: ConfigService): AnyCatalogProvider[] {
  ...
  // UnlimPlay SEGUNDO: español latino, m3u8 directo + extractores + FlareSolverr.
  providers.push(new UnlimplayCatalogProvider(config));

  // Vidlink TERCERO: inglés con subtítulos multi-idioma.
