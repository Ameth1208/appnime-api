...
@Module({
  ...
  providers: [JwtAuthGuard, TokenService, RegisterUserUseCase, CreateAuthSessionUseCase, LoginUserUseCase, LoginAdminUseCase, RefreshSessionUseCase, LogoutUseCase],
